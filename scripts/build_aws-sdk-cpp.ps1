...
&$msbuild ALL_BUILD.vcxproj /m /p:Configuration=$CONFIGURATION -warnaserror -noerr:C4996;C2220
&$msbuild INSTALL.vcxproj /m /p:Configuration=$CONFIGURATION -warnaserror -noerr:C4996;C2220
